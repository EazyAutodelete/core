...
const eazyautodelete_db_client_1 = __importDefault(
  require("@eazyautodelete/eazyautodelete-db-client")
);
...
const eazyautodelete_lang_1 = require("@eazyautodelete/eazyautodelete-lang");
...
class Bot extends discord_js_1.Client {
  constructor(config) {
    ...
    setInterval(() => {
      ...
      const data = (0, fs_1.readFileSync)(this.eventLogPath, {
        encoding: "utf-8",
      });
      (0, fs_1.writeFileSync)(this.eventLogPath, `${data}${this.eventLog}`);
      this.eventLog = ``;
    }, 1000);
    // stats
    this.stats = {
    ...
    // language
    this.locales = eazyautodelete_lang_1.locales;
    this.Translator = eazyautodelete_lang_1.Translator;
    this.translate = eazyautodelete_lang_1.translate;
    ...
    // database
    this.database = new eazyautodelete_db_client_1.default(
      {
        redis: (_a = this.config) === null || _a === void 0 ? void 0 : _a.redis,
        mongo: (_b = this.config) === null || _b === void 0 ? void 0 : _b.mongo,
      },
      this.Logger
    );
    this.activeChannels = [];
  ...
  registerEvents(dir = "") {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      for (const file of files) {
        const stat = yield promises_1.default.lstat(`${dir}/${file}`);
